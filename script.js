document.addEventListener('DOMContentLoaded', function() {
    ...
    const cardapioData = {
        segunda: `<div class="menu-grid"><div class="menu-card"><h3>Café da Manhã</h3><p><strong>Pão:</strong> Pão Francês (CG)</p><p><strong>Complemento:</strong> Margarina com Sal</p><p><strong>Bebidas:</strong> Café, Leite Integral (CL), Suco de Cajú</p><p><strong>Fruta:</strong> Maçã</p></div><div class="menu-card"><h3>Almoço</h3><p><strong>Prato Proteico:</strong> Peixe Desfiado</p><p><strong>Opção Vegetariana:</strong> Torta de Soja (CG) (CL)</p><p><strong>Guarnição:</strong> Batata Sauté</p><p><strong>Acompanhamentos:</strong> Arroz e Feijão</p><p><strong>Sobremesa:</strong> Goiabada / Mamão</p></div><div class="menu-card"><h3>Jantar</h3><p><strong>Prato Proteico:</strong> Filé de Peixe à Milanesa (CG)</p><p><strong>Opção Vegetariana:</strong> Estrogonofe de Grão-de-Bico (CL)</p><p><strong>Guarnição:</strong> Purê de Batata (CL)</p><p><strong>Acompanhamentos:</strong> Arroz e Feijão</p><p><strong>Sobremesa:</strong> Abacaxi</p></div></div>`,
        terca: `<div class="menu-grid"><div class="menu-card"><h3>Café da Manhã</h3><p><strong>Pão:</strong> Pão de Hot Dog (CG)</p><p><strong>Complemento:</strong> Manteiga com Sal</p><p><strong>Bebidas:</strong> Café, Leite Integral (CL), Suco de Goiaba</p><p><strong>Fruta:</strong> Banana</p></div><div class="menu-card"><h3>Almoço</h3><p><strong>Prato Proteico:</strong> Sobrecoxa de Frango Assado</p><p><strong>Opção Vegetariana:</strong> Hambúrger de Soja (CG)</p><p><strong>Guarnição:</strong> Canjiquinha Salgada</p><p><strong>Acompanhamentos:</strong> Arroz e Feijão</p><p><strong>Sobremesa:</strong> Melão</p></div><div class="menu-card"><h3>Jantar</h3><p><strong>Prato Proteico:</strong> Carne Moída com Abobrinha e Batata</p><p><strong>Opção Vegetariana:</strong> Torta de Grão-de-Bico com Couve e Cenoura (CG)</p><p><strong>Guarnição:</strong> Espaguete ao Alho e Óleo (CG)</p><p><strong>Acompanhamentos:</strong> Arroz e Feijão</p><p><strong>Sobremesa:</strong> Maçã</p></div></div>`,
        quarta: `<div class="menu-grid"><div class="menu-card"><h3>Café da Manhã</h3><p><strong>Pão:</strong> Pão Francês (CG)</p><p><strong>Complemento:</strong> Manteiga com Sal</p><p><strong>Bebidas:</strong> Café, Leite Integral (CL), Suco de Graviola</p><p><strong>Fruta:</strong> Melancia</p></div><div class="menu-card"><h3>Almoço</h3><p><strong>Prato Proteico:</strong> Pernil Assado ao Molho de Abacaxi</p><p><strong>Opção Vegetariana:</strong> Quibe Vegetariano (CG)</p><p><strong>Guarnição:</strong> Quibebe de Abóbora</p><p><strong>Acompanhamentos:</strong> Arroz e Feijão</p><p><strong>Sobremesa:</strong> Gelatina de Morango / Banana Prata</p></div><div class="menu-card"><h3>Jantar</h3><p><strong>Prato Proteico:</strong> Escondidinho de Carne Moída</p><p><strong>Opção Vegetariana:</strong> Soja em Grãos com Legumes</p><p><strong>Guarnição:</strong> Farofa com Cenoura e Milho Verde (CL)</p><p><strong>Acompanhamentos:</strong> Arroz e Feijão</p><p><strong>Sobremesa:</strong> Maçã</p></div></div>`,
        quinta: `<div class="menu-grid"><div class="menu-card"><h3>Café da Manhã</h3><p><strong>Pão:</strong> Pão de Hot Dog (CG)</p><p><strong>Complemento:</strong> Margarina com Sal</p><p><strong>Bebidas:</strong> Café, Leite Integral (CL), Suco de Goiaba</p><p><strong>Fruta:</strong> Banana Prata</p></div><div class="menu-card"><h3>Almoço</h3><p><strong>Prato Proteico:</strong> Sobrecoxa de Frango Assado</p><p><strong>Opção Vegetariana:</strong> Ovos Fritos</p><p><strong>Guarnição:</strong> Polenta com Queijo</p><p><strong>Acompanhamentos:</strong> Arroz e Feijão</p><p><strong>Sobremesa:</strong> Maçã</p></div><div class="menu-card"><h3>Jantar</h3><p><strong>Prato Proteico:</strong> Copa Lombo Grelhado</p><p><strong>Opção Vegetariana:</strong> Torta de Grão-de-Bico com Couve e Cenoura</p><p><strong>Guarnição:</strong> Canjiquinha Salgada</p><p><strong>Acompanhamentos:</strong> Arroz e Feijão</p><p><strong>Sobremesa:</strong> Melão</p></div></div>`,
        sexta: `<div class="menu-grid"><div class="menu-card"><h3>Café da Manhã</h3><p><strong>Pão:</strong> Pão Francês (CG)</p><p><strong>Complemento:</strong> Manteiga com Sal</p><p><strong>Bebidas:</strong> Café, Leite Integral (CL), Suco de Acerola</p><p><strong>Fruta:</strong> Mamão</p></div><div class="menu-card"><h3>Almoço</h3><p><strong>Prato Proteico:</strong> Iscas de Carne Acebolada</p><p><strong>Opção Vegetariana:</strong> Hambúrger de Soja (CG)</p><p><strong>Guarnição:</strong> Farofa de Banana da Terra</p><p><strong>Acompanhamentos:</strong> Arroz e Feijão</p><p><strong>Sobremesa:</strong> Doce de Leite / Melão</p></div><div class="menu-card"><h3>Jantar</h3><p><strong>Prato Proteico:</strong> Peixe Frito</p><p><strong>Opção Vegetariana:</strong> Omelete</p><p><strong>Guarnição:</strong> Pirão / Pirão de Legumes</p><p><strong>Acompanhamentos:</strong> Arroz e Feijão</p><p><strong>Sobremesa:</strong> Mousse de Chocolate / Banana Prata</p></div></div>`,
        sabado: `<div class="menu-grid menu-grid-single"><div class="menu-card"><h3>Almoço</h3><p><strong>Entrada:</strong> Acelga com Tomate, Beterraba Ralada</p><p><strong>Prato Proteico:</strong> Sassami à Milanesa (CG)</p><p><strong>Opção Vegetariana:</strong> Panqueca de Soja (CG)</p><p><strong>Guarnição:</strong> Yakissoba (CG)</p><p><strong>Acompanhamentos:</strong> Arroz e Feijão</p><p><strong>Sobremesa:</strong> Melancia</p><p><strong>Suco:</strong> Morango</p></div></div>`
    };
